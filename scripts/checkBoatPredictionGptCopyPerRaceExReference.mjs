...
const activeBlockOrder = ["時間帯:", "【出走表】", "【KURARI BOAT EX 参照情報】", "【KURARI BOAT EX 当日予想coverage】", "【KURARI BOAT EX 天候・水面 履歴】", "【KURARI BOAT EX 履歴latest-day venue-evidence】", "【KURARI BOAT EX レース帯履歴】", "【展示情報】", "【EXレース分析】", "【EX選手情報】", "【KURARI BOAT EX 選手特徴】", "【source-backed / cautions】"];
const forbidden = ["fake", "score", "rank", "generatedPrediction", "generatedTicket", "【KURARI BOAT EX 当日coverage】", "当日coverage: 対象日不一致のため予想当日データとしては使わない"];
...
const checks = {
	...
	activePerRaceBlock: activeBlock.includes("【KURARI BOAT EX 参照情報】") && activeBlock.includes("【KURARI BOAT EX 当日予想coverage】") && activeBlock.includes("【KURARI BOAT EX 履歴latest-day venue-evidence】") && !activeBlock.includes("【KURARI BOAT EX 当日coverage】") && activeBlock.includes("当日EXレース分析: 未取得"),
