...
- read-only review files: 1478
- read-only dog summaries: 378
- historyReady dates created: 65
- missing registration appearances: 53148
- unresolved source conditions: 20
